AddCSLuaFile("entities/verus_aac_hb_smc_flipup/cl_init.lua")
AddCSLuaFile("entities/verus_aac_hb_smc_flipup/shared.lua")
include("entities/verus_aac_hb_smc_flipup/shared.lua")
