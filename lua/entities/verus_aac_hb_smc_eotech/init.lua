AddCSLuaFile("entities/verus_aac_hb_smc_eotech/cl_init.lua")
AddCSLuaFile("entities/verus_aac_hb_smc_eotech/shared.lua")
include("entities/verus_aac_hb_smc_eotech/shared.lua")
