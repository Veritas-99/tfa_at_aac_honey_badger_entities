AddCSLuaFile("entities/verus_aac_hb_smc_barska/cl_init.lua")
AddCSLuaFile("entities/verus_aac_hb_smc_barska/shared.lua")
include("entities/verus_aac_hb_smc_barska/shared.lua")
