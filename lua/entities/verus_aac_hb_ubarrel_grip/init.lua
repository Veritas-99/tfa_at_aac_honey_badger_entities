AddCSLuaFile("entities/verus_aac_hb_ubarrel_grip/cl_init.lua")
AddCSLuaFile("entities/verus_aac_hb_ubarrel_grip/shared.lua")
include("entities/verus_aac_hb_ubarrel_grip/shared.lua")
