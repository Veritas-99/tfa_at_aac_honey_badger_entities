AddCSLuaFile("entities/verus_aac_hb_smc_c79/cl_init.lua")
AddCSLuaFile("entities/verus_aac_hb_smc_c79/shared.lua")
include("entities/verus_aac_hb_smc_c79/shared.lua")
