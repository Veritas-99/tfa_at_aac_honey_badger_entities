AddCSLuaFile("entities/verus_aac_hb_smc_specter/cl_init.lua")
AddCSLuaFile("entities/verus_aac_hb_smc_specter/shared.lua")
include("entities/verus_aac_hb_smc_specter/shared.lua")
